...
namespace JokesWebApp.Controllers
{
    ...
    {
        private readonly JokesWebAppDbContext _context;

        public JokesController(JokesWebAppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Joke != null ?
                        ...
                        Problem("Entity set 'JokesWebAppDbContext.Joke'  is null.");
        }


        // GET: Jokes/ShowSearchFrom
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JokesWebAppDbContext.Joke'  is null.");
            }
            var joke = await _context.Joke.FindAsync(id);
            if (joke != null)
            {
